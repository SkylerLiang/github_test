...
{
    {.Kp = 40, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 1
...
{
    {.Kp = 1.0, .Ki = 0.0, .Kd = 0.00, .Max = 520, .Min = -520},	//ID = 1
...
void GM6020_Set_Speed(int goal_speed, int ID)
{
    ...
    GM6020_Speed_Pid[id].Err_1 = GM6020_Speed_Pid[id].Err;
		GM6020_Speed_Pid[id].Speed = GM6020_Get_Speed(ID);
    GM6020_Speed_Pid[id].Err 	= goal_speed - GM6020_Speed_Pid[id].Speed;
