...
//	{.Kp = 0, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 1
//	{.Kp = 0, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 1
	{.Kp = 80, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 1
		{.Kp = 80, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 2
	{.Kp = 80, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 3
	{.Kp = 80, .Ki = 0, .Kd = 0, .Max = 300000, .Min = -300000}, //ID = 4
...
//	{.Kp = 0, .Ki = 0, .Kd = 0.00, .Max = 520, .Min = -520,.I_Start_Err = 70},
	...
	{.Kp = 0.65, .Ki = 0.017, .Kd = 0.00, .Max = 520, .Min = -520,.I_Start_Err = 200},	//ID = 2
...
//	GM6020_CAN_Send_Data(&hfdcan1, can_Sendbuf, send_id, 8);
	GM6020_CAN_Send_Data(&hfdcan2, can_Sendbuf, send_id, 8);
//		GM6020_CAN_Send_Data(&hfdcan3, can_Sendbuf, send_id, 8);
